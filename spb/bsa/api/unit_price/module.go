...
import (
	handler "spb/bsa/api/unit_price/handler"
	"spb/bsa/api/unit_price/service"
...
func LoadModule(router fiber.Router, customMiddleware middleware.ICustomMiddleware) {
	...
	unitPriceRoute.Put("/:id", UnitPriceHandler.Update, customMiddleware.CheckAccess("unit_price:update"))
