...
import (
	handler "spb/bsa/api/location/handler"
	"spb/bsa/api/location/service"
...
func LoadModule(router fiber.Router, customMiddleware middleware.ICustomMiddleware) {
	...
	locationRoute.Put("/:id", LocationHandler.Update, customMiddleware.CheckAccess("location:update"))
