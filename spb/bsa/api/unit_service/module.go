...
import (
	handler "spb/bsa/api/unit_service/handler"
	"spb/bsa/api/unit_service/service"
...
var (
	UnitServiceService service.IService
	UnitServiceHandler handler.IHandler
)
...
func LoadModule(router fiber.Router, customMiddleware middleware.ICustomMiddleware) {
	...
	unitServiceRoute.Put("/:id", UnitServiceHandler.Update, customMiddleware.CheckAccess("unit_service:update"))
