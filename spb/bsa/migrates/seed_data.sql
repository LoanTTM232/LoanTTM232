...
VALUES
	('afb5c6c7-4720-4e1c-8396-c9ada7b9c411' :: uuid, 'user:list', NOW(),NOW()),
	('f15f644d-07b7-4aa1-a2d5-c8d09c75de64' :: uuid, 'user:read', NOW(),NOW()),
	('48f78a0c-0ef7-4421-89f6-57f327f93b87' :: uuid, 'user:create', NOW(),NOW()),
	('ff141b2b-19df-4eed-b72c-b4befcf210f0' :: uuid, 'user:update', NOW(),NOW()),
	('d11b8ea5-11bc-44cb-9e82-26785c1b420b' :: uuid, 'user:delete', NOW(),NOW()),
	('d7fe40c7-3961-4bf6-970a-08fb33209870' :: uuid, 'unit_service:create', NOW(),NOW()),
	('72cdcd72-e94c-4c03-92ce-462c4c719699' :: uuid, 'unit_service:update', NOW(),NOW()),
	('c397fa8a-20d7-4ec4-9d0e-ba164710fb03' :: uuid, 'unit_service:delete', NOW(),NOW()),
	('91364a8e-0734-4a5c-81cb-58f4b02c9b23' :: uuid, 'club:create', NOW(),NOW()),
	('6a30974f-29fa-4f53-9d93-29de1ce1bd5c' :: uuid, 'club:update', NOW(),NOW()),
	('ccdac793-c1e7-4756-ae01-719283ef5089' :: uuid, 'club:delete', NOW(),NOW()),
	('06ce821d-5db8-4993-b088-79c4b78110ff' :: uuid, 'unit:create', NOW(),NOW()),
	('cf5a936d-3e9d-4175-925f-728a8b113c81' :: uuid, 'unit:update', NOW(),NOW()),
	('9cbdef70-fc8a-484a-88e4-0e4781b7a1b0' :: uuid, 'unit:delete', NOW(),NOW()),
	('c392852d-281b-4b17-94dd-ebb67d0b452b' :: uuid, 'location:create', NOW(),NOW()),
	('da137b1e-1f5f-451f-a426-4a55e952e34d' :: uuid, 'metadata:create', NOW(),NOW()),
	('15f98766-be1c-4247-bb97-d494b9533c03' :: uuid, 'metadata:read', NOW(),NOW()),
	('faba17b0-3688-4ea3-83b3-037fb7931fd8' :: uuid, 'order:list', NOW(),NOW()),
	('6b2b754c-c474-424a-a835-131ce5e7d1f9' :: uuid, 'order:read', NOW(),NOW()),
	('0caff751-b8f0-42f8-87b7-6195d5f8659b' :: uuid, 'order:create', NOW(),NOW()),
	('cb804a5d-22eb-4250-9c1b-662cdea5e1f9' :: uuid, 'order:approve_request', NOW(),NOW()),
	('e3851eca-e550-4857-915d-f7ea19eb2f1f' :: uuid, 'order:approve_payment', NOW(),NOW());

INSERT INTO
	"role" (id, "name", parent_id, created_at, updated_at)
VALUES
	('cc203bb9-7b33-4391-8917-0089588356f2' :: uuid, 'admin', null,
		NOW (),
		NOW ()
	),
	('6c8647dc-091f-4249-b9f7-12bed594d124' :: uuid, 'client', 'cc203bb9-7b33-4391-8917-0089588356f2' :: uuid,
		NOW (),
		NOW ()
	),
	('9666740a-4ff5-4d22-830f-ab3361ba5ef4' :: uuid, 'user', '6c8647dc-091f-4249-b9f7-12bed594d124' :: uuid,
		NOW (),
		NOW ()
	);
