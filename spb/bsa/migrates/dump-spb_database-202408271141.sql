...
--
-- Name: service; Type: TABLE; Schema: public; Owner: spb_user
--
...
ALTER TABLE public.service OWNER TO spb_user;
...
cb6541f1-a32b-42aa-a6b2-1e84024fa076	2024-08-27 04:37:32.383748+00	2024-08-27 04:37:32.383748+00	\N	create_user
728b7199-8d4b-4a2d-bd97-7b53f284091c	2024-08-27 04:37:32.383748+00	2024-08-27 04:37:32.383748+00	\N	update_user
3008638a-ea1c-4be3-9d24-1b2ebd578bc0	2024-08-27 04:37:32.383748+00	2024-08-27 04:37:32.383748+00	\N	delete_user
1683cbe9-8076-40da-8210-624a600e340d	2024-08-27 04:37:32.383748+00	2024-08-27 04:37:32.383748+00	\N	read_user
\.
...
cc203bb9-7b33-4391-8917-0089588356f2	2024-08-27 04:37:32.396546+00	2024-08-27 04:37:32.396546+00	\N	admin	\N	\N
6c8647dc-091f-4249-b9f7-12bed594d124	2024-08-27 04:37:32.396546+00	2024-08-27 04:37:32.396546+00	\N	client	\N	cc203bb9-7b33-4391-8917-0089588356f2
9666740a-4ff5-4d22-830f-ab3361ba5ef4	2024-08-27 04:37:32.396546+00	2024-08-27 04:37:32.396546+00	\N	user	\N	6c8647dc-091f-4249-b9f7-12bed594d124
\.
...
--
-- Data for Name: service; Type: TABLE DATA; Schema: public; Owner: spb_user
--

COPY public.service (id, created_at, updated_at, deleted_at, name, icon, price, description, status, unit_id) FROM stdin;
\.
...
--
-- Name: service service_pkey; Type: CONSTRAINT; Schema: public; Owner: spb_user
--
...
--
-- Name: service fk_unit_services; Type: FK CONSTRAINT; Schema: public; Owner: spb_user
--

ALTER TABLE ONLY public.service
    ADD CONSTRAINT fk_unit_services FOREIGN KEY (unit_id) REFERENCES public.unit(id);
