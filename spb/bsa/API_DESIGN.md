...
| 8   | &#x2705;    | POST   | /auth/verify-register-token        |            | Club Owner, Member, User can reset password             |
| 9   | &#x2705;    | POST   | /auth/verify-register-token/resend |            | Club Owner, Member, User can reset password             |
| 10  | &#x2705;    | POST   | /auth/verify-forgot-password-token |            | Club Owner, Member, User can reset password             |
