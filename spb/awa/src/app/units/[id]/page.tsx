  ...
  useEffect(() => {
    const fetchUnitDetails = async () => {
      ...
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/units/${params.id}`, {
          headers: {
  ...
  useEffect(() => {
    const fetchBookedTimes = async () => {
      ...
      try {
        ...
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/units/${params.id}/booked-time`, {
          method: 'POST',
          headers: {
            'Authorization': `Bearer ${token}`,
